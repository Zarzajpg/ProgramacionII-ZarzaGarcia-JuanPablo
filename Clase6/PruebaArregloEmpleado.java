...
public class PruebaArregloEmpleado {
    public static void main(String[] args) {
        ...
        empleados[0] = new EmpleadoXHora("Carlos Carlos", 32156, 160, 12.50);
        empleados[1] = new EmpleadoAsal("Ana Martínez", 54483, 2500.00, 350.00);
        empleados[2] = new EmpleadoXHora("Roberto Gómez", 78945, 150, 15.00);
        empleados[3] = new EmpleadoAsal("María Marta", 98765, 3000.00, 500.00);
